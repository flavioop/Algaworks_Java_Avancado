...
public class Fazenda extends EmpresaFinanciavel{
    ...
    public static final double TAXA_ACRECISMO_LIMITE_PARA_GRANDE_PROPRIEDADE = 1.2;
    public static final double TAMANHO_MINIMO_EM_HECTATES_GRANDE_PROPRIEDADE = 5;
    ...
    public double calcularLimiteAprovado() {
       ...
       if(getTamanhoEmHectares() >= TAMANHO_MINIMO_EM_HECTATES_GRANDE_PROPRIEDADE){

           limiteAprovado *= TAXA_ACRECISMO_LIMITE_PARA_GRANDE_PROPRIEDADE;
